...
RedStone consumers will be able to use the data published by your node [on all supported chains.](../get-started/supported-chains) You can learn more about the RedStone Oracles architecture [here.](../get-started/how-it-works.md)
:::
